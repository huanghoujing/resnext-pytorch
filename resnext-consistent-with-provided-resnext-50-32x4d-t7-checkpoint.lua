...
-- Modified by Houjing Huang, to make this file consistent with https://s3.amazonaws.com/resnext/imagenet_models/resnext_50_32x4d.t7
...
local function createModel(opt)
   ...
   -- The difference is whether to wrap the first two conv layers in an extra nn.Sequential(), i.e. s1
   ----------------------------------------------------------------------------------------------------
